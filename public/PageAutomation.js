...
class StudentSidebarComponent extends HTMLElement {
  connectedCallback() {
    this.innerHTML = `
    <!-- Sidebar -->
    <aside id="sidebar" class="w-64 bg-white border-gray-400 flex flex-col justify-between h-screen">
      <!-- Sidebar Content -->
      <div>
        <div class="profile p-8 text-center">
    ...
    <aside id="minimizedSidebar" class="w-16 bg-white border-r border-gray-400 flex flex-col justify-center h-screen hidden">
      ...
      <div class="p-2 flex flex-col items-center">
        ...
        <a href="StudentCourses.html" class="text-blue-500 hover:text-blue-900 my-2"><i class="fas fa-graduation-cap"></i></a>
  ...
  connectedCallback() {
      ...
      <header class="bg-white p-1 border-b-2 border-gray-400">
        ...
        <div class="flex items-center justify-between border-b border-gray-300 p-4">
          <a href="StudentHome.html" class="text-xl text-black font-semibold">LMS.</a>
          ...
          <div class="flex items-center space-x-4">
              ...
              <div class="text-xl cursor-pointer" id="burgerToggleBtn">
              ...
              <div class="relative flex items-center space-x-4">
                ...
                <div class="relative">
                  ...
                  <!-- Dropdown Content -->
                  <div class="absolute hidden bg-white text-gray-800 right-0 mt-2 p-2 rounded shadow-lg" id="dropdownContent">
                    ...
                    <a href="Login.html" class="flex items-center w-full text-left py-2 px-4 hover:bg-gray-200" onclick="return confirm('Are you sure you want to log out?');">
